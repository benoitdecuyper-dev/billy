...
h += `<ul><li>La posture et les <strong>formulations</strong> (le répertoire fermé, phase par phase — Annexe A).</li><li>La <strong>sécurité de l'approche 2-5 ans</strong> (le point le plus sensible).</li><li>La couche <strong>anti-suggestion</strong> et le <strong>seuil de détection</strong> (ni manqué, ni sur-alerte).</li><li>L'<strong>escalade</strong> et le <strong>rapport</strong> (verbatim brut, sans interprétation).</li><li>Le conflit d'intérêts : l'adulte présent (le téléphone est posé près de l'enfant, pas tenu) peut être la personne en cause.</li></ul>`;
