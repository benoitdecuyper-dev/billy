 ...
 */
import { writeReportDocx } from '../src/report/generateReport.js';
...
const out = process.argv[2] || 'docs/Rapport_Billy_exemple.docx';
writeReportDocx(exemple, out).then((p) => console.log('Rapport exemple écrit :', p));
